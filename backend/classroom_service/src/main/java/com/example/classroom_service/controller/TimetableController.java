...
public class TimetableController {
    ...
    // Section timetable — weekly grouped view
    ...
    public ResponseEntity<ApiResponse<List<TimetableEntryDTO.WeeklyResponse>>> getWeeklyByClassroom(
            @PathVariable Long classroomId) {
        return ResponseEntity.ok(ApiResponse.success(timetableService.getWeeklyByClassroom(classroomId)));
    }

    // Section timetable — single day
    ...
    // Faculty timetable — weekly grouped view
